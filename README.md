> **Senior Product Manager** · Gurgaon, India · 🟢 Open to senior PM roles
...
| 200K+ sessions/mo | 92% cost reduction | ↓16% dropout | 11 yrs |
|:---:|:---:|:---:|:---:|
| Monthly AI interviews | ₹60 → ₹5 per session | After conversational redesign | AI · SaaS · D2C |

---

### Building now

🟢 **[undrlyn](https://undrlyn.com)** — Reading companion for physical books. OCR extracts highlights, builds a timeline of thoughts. *Your highlights are a diary you didn't know you were writing.*
`Next.js 14` `Supabase` `Google Vision` `Vercel`

⚪ **[AsthaAI](https://astha-ai-mu.vercel.app)** — Intent-first search on InstaAstro. Closes the gap between what users type and what they mean.
`OpenAI` `Vercel`

⚪ **[Spinny Inspector](https://spinny-inspector.vercel.app)** — 60-point mobile-first car inspection workflow for field ops.
`prototype`
